...
public class LoggingFilter implements Filter {
    ...
    // Överskriv doFilter metoden i Filter-interface. Denna metod körs för varje request och response i applikationen.
    @Override
    public void doFilter(
        ...
        // Fortsätt till nästa filter i filterkedjan. Om detta är det sista filtret i kedjan kommer requestet att
